...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function showLoadingState() {
    ...
    if (categoryBreakdownElement) {
      categoryBreakdownElement.innerHTML =
        '<div class="loading-categories">Loading category counts...</div>';
    }
  }
  ...
  function showErrorState() {
    ...
    if (categoryBreakdownElement) {
      categoryBreakdownElement.innerHTML =
        '<div class="error-message">Failed to load mod counts</div>';
    }
  }
  ...
  function animateCounter(element, targetCount) {
    ...
    function updateCounter(currentTime) {
      ...
      const currentCount = Math.floor(
        startCount + (targetCount - startCount) * easeProgress,
      );
  ...
  function updateCategoryBreakdown(categoryCounts) {
    ...
    const categoryItems = categoryBreakdownElement.querySelectorAll(
      ".category-count-item",
    );
